export default {
  learningRecommendation: {
    ...
    why: "为什么推荐",
    anchors: "支持本建议的知识节点",
    onlyRecommended: "只看推荐",
    legend: "下一步学习建议（外圈排名）",
    empty: "暂无相关的未点亮候选。继续学习或产生新证据后刷新。",
    noWiki: "当前知识库尚未启用 Wiki。",
    failed: "推荐加载失败，个人知识图仍可使用。",
    loading: "正在计算学习建议…",
    truncated: "推荐基于有界 Wiki 切片，不代表全库排名。",
    uncertain: "未点亮表示尚无学习证据，不代表你一定不了解。",
    rank: "推荐排名 #{rank}",
    adjacentFamiliar: "与已熟悉的知识在 Wiki 中直接相连。",
    adjacentMastered: "与标记为已掌握的知识在 Wiki 中直接相连。",
    adjacentExposed: "与已接触的知识在 Wiki 中直接相连。",
    twoHop: "通过两条 Wiki 链接关联到已有学习区域。",
    multipleAnchors: "得到多个已有学习证据的知识节点支持。",
    memorySupport: "与长期记忆已关联的知识区域相关。",
    recentContext: "关联到近期学习过的知识区域。",
  },
  platformApiKeys: {
    title: '平台 API Key',
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      tabProfile: '个人画像',
      tabProfileTip: '在当前 Wiki 知识网络上叠加你的学习证据与知识状态',
      profileTitle: '个人知识画像',
      profileLastUpdated: '最后更新',
      profileRefresh: '刷新画像',
      profileLit: '已点亮',
      profileSearch: '搜索 WikiPage 标题',
      profileLitOnly: '只看已点亮',
      profileIncludeContext: '包含上下文节点',
      profileTechnical: '显示技术详情',
      profileLoadFailed: '知识状态加载失败，Wiki 图仍可继续使用。',
      profileNoEvidence: '当前还没有学习证据，开始与该知识库对话后，相关节点会逐步点亮。',
      profileEvidenceCount: '证据数量',
      profileConfidence: '证据可靠度',
      profileLastEvidence: '最近证据',
      profileEvidenceTitle: '学习证据',
      profileEvidenceFailed: '证据加载失败，请重试。',
      profileNoNodeEvidence: '此节点暂无学习证据。',
      statusAll: '全部状态',
      statusUnknown: '无证据',
      statusExposed: '已接触',
      statusFamiliar: '熟悉',
