export default {
  learningRecommendation: {
    ...
    why: "추천 이유",
    anchors: "관련 지식 노드",
    onlyRecommended: "추천만 보기",
    legend: "다음 학습 추천 (순위 테두리)",
    empty: "관련된 미확인 후보가 없습니다. 학습 후 새 증거가 생기면 새로고침하세요.",
    noWiki: "이 지식 베이스에서 Wiki가 활성화되지 않았습니다.",
    failed: "추천을 불러오지 못했습니다. 지식 그래프는 계속 사용할 수 있습니다.",
    loading: "학습 추천 계산 중…",
    truncated: "제한된 Wiki 범위의 추천이며 전체 지식 베이스 순위는 아닙니다.",
    uncertain: "미확인은 학습 증거가 없다는 뜻이며, 반드시 모른다는 뜻은 아닙니다.",
    rank: "추천 순위 #{rank}",
    adjacentFamiliar: "익숙한 지식과 Wiki에서 직접 연결되어 있습니다.",
    adjacentMastered: "습득한 것으로 표시된 지식과 Wiki에서 직접 연결되어 있습니다.",
    adjacentExposed: "접한 지식과 Wiki에서 직접 연결되어 있습니다.",
    twoHop: "두 개의 Wiki 링크로 학습 영역과 연결됩니다.",
    multipleAnchors: "학습 증거가 있는 여러 지식 노드가 뒷받침합니다.",
    memorySupport: "장기 기억과 연결된 지식 영역과 관련됩니다.",
    recentContext: "최근 학습한 지식 영역과 연결됩니다.",
  },
  platformApiKeys: {
    title: '플랫폼 API 키',
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      tabProfile: '개인 프로필',
      tabProfileTip: '현재 Wiki 네트워크에 학습 근거와 지식 상태를 겹쳐 표시합니다',
      profileTitle: '개인 지식 프로필',
      profileLastUpdated: '마지막 업데이트',
      profileRefresh: '프로필 새로고침',
      profileLit: '활성 노드',
      profileSearch: 'WikiPage 제목 검색',
      profileLitOnly: '활성 노드만',
      profileIncludeContext: '문맥 노드 포함',
      profileTechnical: '기술 세부정보 표시',
      profileLoadFailed: '지식 상태를 불러오지 못했습니다. Wiki 그래프는 계속 사용할 수 있습니다.',
      profileNoEvidence: '아직 학습 근거가 없습니다. 이 지식 베이스와 대화하면 관련 노드가 활성화됩니다.',
      profileEvidenceCount: '근거 수',
      profileConfidence: '근거 신뢰도',
      profileLastEvidence: '최근 근거',
      profileEvidenceTitle: '학습 근거',
      profileEvidenceFailed: '근거를 불러오지 못했습니다. 다시 시도하세요.',
      profileNoNodeEvidence: '이 노드에는 학습 근거가 없습니다.',
      statusAll: '모든 상태',
      statusUnknown: '근거 없음',
      statusExposed: '접촉함',
      statusFamiliar: '익숙함',
      statusMastered: '숙달',
      evidenceChat: '채팅 상호작용',
      evidenceMemory: '장기 기억',
