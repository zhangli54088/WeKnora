export default {
  learningProfileData: {
    export: 'Экспорт профиля обучения',
    more: 'Ещё',
    delete: 'Удалить профиль обучения',
    confirmBody: 'Будут удалены все свидетельства обучения, состояния узлов и связи Memory-Wiki вашего аккаунта в этом рабочем пространстве, во всех базах знаний. Долговременная память, документы баз знаний (KB), страницы Wiki, общий граф и данные других пользователей НЕ удаляются. Действие необратимо; новые диалоги могут восстановить профиль.',
    exportSuccess: 'Профиль обучения экспортирован',
    exportFailed: 'Ошибка экспорта. Повторите попытку; граф остаётся доступным.',
    deleteSuccess: 'Профиль удалён. Память и общий граф сохранены.',
    deleteFailed: 'Ошибка удаления. Повторите попытку; граф не затронут.',
    empty: 'Профиль обучения пока пуст. Продолжайте общение с этой базой знаний, чтобы связанные узлы снова подсветились.',
  },
  learningRecommendation: {
    title: "Следующие шаги обучения",
    score: "Оценка рекомендации {score}%",
    why: "Почему это рекомендовано",
    anchors: "Связанные узлы знаний",
    onlyRecommended: "Только рекомендации",
    legend: "Следующий шаг (кольцо с рангом)",
    empty: "Пока нет связанных кандидатов без свидетельств обучения. Продолжайте учиться и обновите данные.",
    noWiki: "Wiki не включена для этой базы знаний.",
    failed: "Не удалось загрузить рекомендации. Граф знаний по-прежнему доступен.",
    loading: "Расчёт рекомендаций…",
    truncated: "Рекомендации основаны на ограниченном фрагменте Wiki, а не на всей базе.",
    uncertain: "Неизвестный статус означает отсутствие свидетельств обучения, а не незнание.",
    rank: "Ранг рекомендации #{rank}",
    adjacentFamiliar: "Напрямую связан в Wiki со знакомыми знаниями.",
    adjacentMastered: "Напрямую связан в Wiki со знаниями, отмеченными как освоенные.",
    adjacentExposed: "Напрямую связан в Wiki со знаниями, с которыми вы сталкивались.",
    twoHop: "Связан с областью обучения через две ссылки Wiki.",
    multipleAnchors: "Поддерживается несколькими узлами со свидетельствами обучения.",
    memorySupport: "Связан с областью знаний, отмеченной в долговременной памяти.",
    recentContext: "Связан с недавно изучаемой областью знаний.",
  },
  platformApiKeys: {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      tabProfile: 'Личный профиль',
      tabProfileTip: 'Наложение ваших учебных свидетельств и состояний знаний на сеть Wiki',
      profileTitle: 'Личный профиль знаний',
      profileLastUpdated: 'Последнее обновление',
      profileRefresh: 'Обновить профиль',
      profileLit: 'Активные узлы',
      profileSearch: 'Поиск по заголовкам WikiPage',
      profileLitOnly: 'Только активные',
      profileIncludeContext: 'Включить контекст',
      profileTechnical: 'Показать технические сведения',
      profileLoadFailed: 'Не удалось загрузить состояния знаний. Граф Wiki остаётся доступен.',
      profileNoEvidence: 'Учебных свидетельств пока нет. Узлы будут активироваться по мере общения с этой базой знаний.',
      profileEvidenceCount: 'Число свидетельств',
      profileConfidence: 'Надёжность свидетельства',
      profileLastEvidence: 'Последнее свидетельство',
      profileEvidenceTitle: 'Учебные свидетельства',
      profileEvidenceFailed: 'Не удалось загрузить свидетельства. Повторите попытку.',
      profileNoNodeEvidence: 'Для этого узла нет учебных свидетельств.',
      statusAll: 'Все состояния',
      statusUnknown: 'Нет свидетельств',
      statusExposed: 'Ознакомлен',
      statusFamiliar: 'Знаком',
      statusMastered: 'Освоено',
      evidenceChat: 'Взаимодействие в чате',
      evidenceMemory: 'Долговременная память',
