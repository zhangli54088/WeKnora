export default {
  learningRecommendation: {
    ...
    anchors: "Supporting knowledge",
    onlyRecommended: "Recommended only",
    legend: "Next-step recommendation (ranked ring)",
    empty: "No related unknown candidates yet. Continue learning or refresh after new evidence.",
    noWiki: "Wiki is not enabled for this knowledge base.",
    failed: "Recommendations could not be loaded. Your graph is still available.",
    loading: "Calculating learning recommendations…",
    truncated: "Recommendations use a bounded Wiki slice; this is not a whole-library ranking.",
    uncertain: "Unknown means no learning evidence yet, not that you certainly do not know it.",
    rank: "Recommendation rank #{rank}",
    adjacentFamiliar: "Directly linked in Wiki to knowledge you are familiar with.",
    adjacentMastered: "Directly linked in Wiki to knowledge marked mastered.",
    adjacentExposed: "Directly linked in Wiki to knowledge you have encountered.",
    twoHop: "Connected to your learning context through two Wiki links.",
    multipleAnchors: "Supported by multiple nodes with learning evidence.",
    memorySupport: "Related to a knowledge area linked to your long-term memory.",
    recentContext: "Connected to a recently active learning area.",
  },
  menu: {
  ...
  knowledgeEditor: {
    ...
    wikiBrowser: {
      ...
      tabProfileTip: 'Overlay your learning evidence and knowledge states on this Wiki network',
      profileTitle: 'Personal Knowledge Profile',
      profileLastUpdated: 'Last updated',
      profileRefresh: 'Refresh profile',
      profileLit: 'Lit nodes',
      profileSearch: 'Search WikiPage titles',
      profileLitOnly: 'Lit nodes only',
      profileIncludeContext: 'Include context nodes',
      profileTechnical: 'Show technical details',
      profileLoadFailed: 'Knowledge states failed to load. The Wiki graph remains available.',
      profileNoEvidence: 'No learning evidence yet. Relevant nodes will light up as you chat with this knowledge base.',
      profileEvidenceCount: 'Evidence count',
      profileConfidence: 'Evidence reliability',
      profileLastEvidence: 'Latest evidence',
      profileEvidenceTitle: 'Learning evidence',
      profileEvidenceFailed: 'Evidence failed to load. Please retry.',
      profileNoNodeEvidence: 'No learning evidence for this node.',
      statusAll: 'All statuses',
      statusUnknown: 'No evidence',
      statusExposed: 'Exposed',
      statusFamiliar: 'Familiar',
      statusMastered: 'Mastered',
      evidenceChat: 'Chat interaction',
      evidenceMemory: 'Long-term memory',
